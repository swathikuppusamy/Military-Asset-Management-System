...
const ExpenditureViewPage = () => {
  ...
  const loadExpenditure = async () => {
    try {
      ...
      const expenditureData = response.data.data || response.data;
  ...
  const handleReject = async () => {
    if (!window.confirm('Are you sure you want to reject this expenditure?')) {
      return;
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="text-center">
          <div className="text-lg text-gray-500 mb-4">Expenditure not found</div>
          <Link to="/expenditures" className="btn-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card title="Expenditure Information">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base font-semibold">{expenditure._id?.slice(-8).toUpperCase() || 'N/A'}</p>
              </div>
              <div>
          ...
          <Card title="Asset Information">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-base">{expenditure.asset?.currentQuantity || 'N/A'}</p>
              </div>
            </div>
          </Card>
          ...
          <Card title="Location & Personnel">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-500">Base Code</label>
                <p className="text-base">{expenditure.base?.code || 'N/A'}</p>
              </div>
              <div>
          ...
          <Card title="Additional Details">
            <div className="space-y-4">
              ...
              {(!expenditure.description && !expenditure.notes) && (
                <div>
                  <p className="text-base text-gray-500 italic">No additional details provided.</p>
                </div>
              )}
            </div>
          </Card>
        ...
        <Card title="Timeline">
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-sm font-medium text-gray-500">Expenditure Date</span>
              <span className="text-sm">
            ...
            {expenditure.approvedDate && (
              <div className="flex justify-between items-center py-2">
                <span className="text-sm font-medium text-gray-500">
                  {expenditure.approved ? 'Approved' : 'Decision Made'}
                </span>
                <span className="text-sm">
...
export default ExpenditureViewPage;